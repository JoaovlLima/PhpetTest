...
$sql = "SELECT * FROM perfilpet ORDER BY id_perfilpet DESC";
...
<body>
  ...
  <tbody>
   ...
   {
echo("<tr>");
echo("<td>".$user_data['id_perfilpet']."</td>");
...
echo("<td>
<a href='../Connection/excluirPet.php?id_perfilpet=$user_data[id_perfilpet]'>
