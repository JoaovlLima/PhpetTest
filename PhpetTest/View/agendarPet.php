...
<button disabled id="continuar" class="continuar" onclick="prosseguir()">Continuar</button>
</div>
</div>

<div class="secao" id="secaoSelecaoRealizada" style="display: none;">
        <h1 class="titulo">SELEÇÃO REALIZADA</h1>
        <div id="petSelecionado">
            <a class="nomePet" id="nomePet"></a>
    ...
    <?php
    // Inicializa uma variável PHP e atribui o valor do h2 a essa variável
    $nomeDoPet;

    // Exibe o nome do pet
    echo "O nome do pet é: " . $nomeDoPet;
    ?>
